...
class StokesFVMSimpleModel(ComputationalModel):
    ...
    def pressure_correction_flux(self, p_corr: TensorLike, ap: TensorLike) -> TensorLike:
    ...
    def enforce_face_flux(self, face_velocity: TensorLike, target_flux: TensorLike) -> TensorLike:
