...
- 90°分流三通优化 (单三通)
主管内直径： Dmain=32mm(对应 DN35 高压管) 支管内直径： Dbranch=25mm(对应 DN25 高压管) 夹角：90∘ (正交三通) 流动方向：主管流入，支管分流 (或合流，视具体配置，默认分流) 初始设计：支管过渡圆角 R=0.5D 直管段延伸：入口前 5D ，出口后 10D(确保流动充分发展)。两根支管内径比主管小。主管与支管连接处有圆弧过度，如果没有圆弧过度，会产生应力。圆弧过渡的那个弧的半径是12.25mm
